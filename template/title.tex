...
\gosttitleobject{Изделие}
\gosttitleobjectI{Изделие}

\gosttitledocument{Инструкция}
\gostreshenie{Решение от --.--.---}

\gostklgi{ДЕЦИ.МАЛЬНЫ.ЙНО МЕ} %То что будет в основной надписи
\gostferstklgi{ДЕЦИ.МАЛЬНЫ.ЙНО МЕ} %Первичное применение

\gostrazrabotchik{Разработчик}
\gostrazrabotchikFIO{Разработчик\,И.\,О.}
\gostDATErazrabotchik{--.--.--}

\gostproveril{Проверивший}
\gostDATEproveril{--.--.----}
  
\gostnormokontroler{Контролёр}
